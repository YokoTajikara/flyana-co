...
/**
 * Class TWEmailController
 * @package App\Http\Controllers
 */
class TWEmailController extends Controller
{
    private $language   = "tw";
    private $genderList = [];
    private $countryList = [];
    ...
    public function registrationGet(AnaRequest $request)
    {
        try {
            ...
            // Handle case when IP is not in database
            $country_name = "Unknown"; // Or set a default value
        ...
        return view('twemail.registration', $data);
    ...
    public function confirmPost(Request $request)
    {
        ...
        if ($validRet->fails()) {
            ...
            return redirect()->action('TWEmailController@registrationGet');
        }
        ...
        return view('twemail.confirm', $data);
    ...
    public function thankyouPost(Request $request)
    {
        ...
        return view('twemail.thanks',compact('region'));
