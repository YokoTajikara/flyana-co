            ...
            <div class="row">
                ...
                <div class="col-xs-12 text-right-side">
                    <select id="lang" onchange="location.href=value">
                        <option value="#" class="selected">台灣中文
    ...
    <section class="section-mainvisual">
        <div class="inner-box">
            <h1 class="hdg">
                ...
                <strong>ANA 電子報!</strong>
            </h1>
            <p class="sbsc-now"><a href="#registration"><img src="/images/tw_ballon.png" alt="立即訂閱"></a></p>
        </div>
    </section>
    <section class="main-contents">
        <div class="outer-box01"><img src="/images/tw_flag.png" alt='Stay connected with ANA'></div>
        <ul class="merit">
            <li>
                <div>
                    <h2>獨家優惠票價</h2>
                    <p>您將優先收到 ANA<br>提供給您的限時優惠票價。</p>                  
                </div>
            ...
            <li>
                <div>
                    <h2>查詢 ANA 優惠活動</h2>
                    <p>千萬別錯過我們提供給<br>您當地的優惠活動及資訊。</p>                
                </div>
            </li>
            <li>
                <div>
                    <h2>了解如何規劃日本之旅</h2>
                    <p>我們提供各種日本旅遊建議，<br>例如必去景點、旅遊知識等。</p>                    
                </div>
            </li>
            <li>
                <div>
                    <h2>ANA 服務資訊</h2>
                    <p>隨時了解 ANA 航班資訊及飛行體驗</p>
                </div>
            </li>
        </ul>
    </section>

    <div id="registration" class="registration hk tw">
        <div class="cloud-img"></div>
        <div class="mainimg">
            <h3 class="title">立即訂閱 ANA 電子報</h3>
        </div>
        <div class="container">
