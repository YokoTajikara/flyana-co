...
<div class="main-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 text-right-side">
                    <select id="lang" onchange="location.href=value">
                        <option value="#" class="selected">ภาษาไทย
    ...
    <section class="section-mainvisual th">
        <div class="inner-box">
            <h1 class="hdg">
                <strong>สมัครรับ<br>จดหมายข่าว ANA!</strong>
            </h1>
        ...
        <ul class="merit th">
            <li>
                <div>
                    ...
                    <p class="th_sp">ได้รับข่าวสารเกี่ยวกับค่าโดยสาร<br>ราคาพิเศษ จำนวนจำกัด<br>จากANA ได้ก่อนใคร</p>
                </div>
            ...
            <li>
                <div>
                    ...
                    <p class="th_sp">ไม่พลาดทุกโปรโมชั่นจากเรา<br> ไม่ว่าจะเป็นข้อมูลแคมเปญ<br> กิจกรรมต่างๆ ในประเทศของท่าน</p>
                </div>
            </li>
            <li>
                <div>
                    <h2>พบข้อมูลในการวางแผน<br>เที่ยวญี่ปุ่น</h2>
                    <p>รับข้อมูลแนะนำการท่องเที่ยวญี่ปุ่น<br>ที่หลากหลาย เช่น สิ่งที่ควรทำ <br> เคล็ดลับการเดินทางและอื่นๆได้</p>                    
                </div>
            </li>
            <li>
                <div>
                    <h2>ข้อมูลเกี่ยวกับ<br>บริการของ ANA</h2>
                    <p>รับข้อมูลอัปเดตเกี่ยวกับเที่ยวบิน<br>และบริการจาก ANA ได้อยู่เสมอ</p>
                </div>
            </li>
        </ul>
    </section>
        ...
        <div class="container">
            ...
            <form method="POST" action="/th/confirm" accept-charset="UTF-8" id="" name="">
                ...
                <div class="contents_form">
                    ...
                    <div class="form-note">
                        <p>ในการสมัครรับจดหมายข่าวANAนี้ ท่านรับรองว่าท่านมีอายุอย่างน้อย 18 ปี  ANAจะใช้ข้อมูลส่วนบุคคลที่ท่านให้ในแบบฟอร์มการสมัครนี้เท่านั้นตาม<a href="https://www.ana.co.jp/wws/privacy/t/ana.html" target="_blank">นโยบายความเป็นส่วนตัวของANA</a> และANAจะปฏิบัติตามคำขอของท่านที่ระบุข้างต้นและคำขอในการเปลี่ยนแปลงใดๆที่ท่านระบุในอนาคตเกี่ยวกับการรับเอกสารทางการตลาดจาก ANA</p>
                    </div>
