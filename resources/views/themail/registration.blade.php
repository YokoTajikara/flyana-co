        ...
        <ul class="merit th">
            <li>
                <div>
                    ...
                    <p class="th_sp">ได้รับข่าวสารเกี่ยวกับค่าโดยสารราคาพิเศษ<br>จำนวนจำกัดจากANA ได้ก่อนใคร</p>                  
                </div>
            ...
            <li>
                <div>
                    ...
                    <p class="th_sp">ไม่พลาดทุกโปรโมชั่นจากเรา<br> ไม่ว่าจะเป็น ข้อมูลแคมเปญ กิจกรรมต่างๆ ในประเทศของท่าน</p>
                </div>
            </li>
            <li>
                <div>
