...
<head>
	...
	<meta name="description" content="ANAウェブサイトで対象の航空券をご購入のお客様限定で、NINJA WiFiを4日間無料で使えるクーポンコードをプレゼント中です">
	<meta property="og:title" content="WiFi 4日間無料 キャンペーン | ANA × NINJA WiFi : GET CONNECTED with ANA">
	<meta property="og:type" content="website">
	<meta property="og:description" content="NINJA WiFiを4日間無料で使えるクーポンコードをプレゼント中です">
	<meta property="og:url" content="https://www.ana-campaign.com/ninjawifi/japanese-po/">
	<meta property="og:image" content="https://www.ana-campaign.com/ninjawifi/image/ogp4.png">
	<meta property="og:site_name" conten="ANA Free WiFi Campaign | GET Connected with ANA">
	<title>WiFi 4日間無料 キャンペーン | ANA × NINJA WiFi : GET CONNECTED with ANA</title>
	<link rel="stylesheet" href="../css/common.css">
	<link rel="stylesheet" href="../css/index.css">
	<link rel="stylesheet" href="css/index-po.css">
@if ($isClosed)
	<link rel="stylesheet" href="css/index-closed-po.css">
@endif
...
<div id="wrapper">
	...
	<div class="header_all">
		<div class="global-header-box clearfix">
			<div class="header_logo"><a href="/ninjawifi/japanese-po" target="_new"><img
...
@if (!$isClosed)
		<!-- nav for PC-->
		<div class="nav">
			<a href="/ninjawifi/form-po?Reservation_number={{ $REC_LOC }}&language={{ $language }}&origin={{ $origin }}"><p><img
		...
		<div class="summary_wrapper">
			<div class="contents">
				...
				<dl class="summary">
					...
					<dd class="period"><span class="sp_br">2016年4月27日<span class="note">(水)</span> 10:00am ～ <span><span
									class="sp_br">2016年7月31日<span class="note">(日)</span> 11:59pm<span
										class="note">※<br>
					( インド時間: 10:29PM / ミャンマー時間 10:59PM / タイ・インドネシア（ジャカルタ）・ベトナム時間: 11:59PM,マレーシア・フィリピン・シンガポール時間: 1:59am -2016年8月1日 / オーストラリア（シドニー）時間: 2:59AM -2016年8月1日 )</span></span>
					</dd>
				</dl>
			</div>
		</div>
			...
			<div class="contents">
				...
				<div class="campaign_title">
					...
					<div class="campaign_title_txt">
						<h3><img src="image/index-po/campaign_ttl01_sp.png" alt="[ANA日本行き航空券WEB予約のお客様 限定]WiFiご契約で4日間無料！"
								 class="switch"></h3>
						...
						<ul>
							<li>NINJA WiFi 4日間 3,600円相当が無料</li>
							<li>さらに安心補償プラン 4日間 1,200円相当も無料</li>
						</ul>
					</div>
				</div>
						...
						<li class="entry01">
							<div class="entry_contents">
								...
								<div class="entry_txt">
									...
									<p class="note">※キャンペーン期間内に、対象の航空券をご予約を行なっていただく必要があります。<a href="http://www.anaskyweb.com/?cid=SBN1604NINJAWIFI4daysJP0440kc" target="_blank">ANAウェブサイトはこちら</a></p>
								</div>
							</div>
						</li>
						<li class="entry02">
							<div class="entry_contents">
								<div class="entry_img"><img src="image/index-po/entry_img02_sp.png" alt="" class="switch">
								</div>
								<div class="entry_txt">
...
@if (!$isClosed)
					<a href="/ninjawifi/form-po?Reservation_number={{ $REC_LOC }}&language={{ $language }}&origin={{ $origin }}">
			...
			<div class="contents">
				...
				<div class="detail_summary">
					<dl class="summary">
						...
						<dd class="period"><span class="sp_br">2016年4月27日<span
									class="note">(水)</span> 10:00am ～ <span><span class="sp_br">2016年7月31日<span
											class="note">(日)</span> 11:59pm<span class="note">※<br>
											( インド時間: 10:29PM / ミャンマー時間 10:59PM / タイ・インドネシア（ジャカルタ）・ベトナム時間: 11:59PM,マレーシア・フィリピン・シンガポール時間: 1:59am -2016年8月1日 / オーストラリア（シドニー）時間: 2:59AM -2016年8月1日 )</span></span>
						</dd>
					</dl>
					<dl class="summary">
						<dt><img src="image/index/detail_img02_sp.png" alt="キャンペーン詳細" class="switch"></dt>
						<dd class="multiline">対象期間中、対象国のANAウェブサイトにて対象国発日本行き航空券をご購入いただき、本サイトでキャンペーンにご応募いただいたお客様にNINJA WiFiクーポンコードをお渡しします。対象期間にNINJA WiFiウェブサイトにてクーポンコードを使用しお申し込みいただくと日本でのWiFiルーターレンタル料金の4日分が無料となります。</dd>
					</dl>
					<dl class="summary">
						<dt><img src="image/index/detail_img05_pc.gif" alt="対象国" class="switch" style="visibility: visible;"></dt>
						<dd class="multiline">インド・インドネシア・オーストラリア・シンガポール・タイ・フィリピン・ベトナム・マレーシア・ミャンマー</dd>
					</dl>
					<dl class="summary">
						<dt><img src="image/index/detail_img03_sp.png" alt="キャンペーン対象者" class="switch"></dt>
						<dd class="multiline">
							<ul>
								<li>対象期間中に対象国のANAウェブサイトにて日本行き航空券をご購入のお客様。</li>
		...
		<div class="attention_wrapper">
			<div class="contents">
				...
				<div class="attention_txt">
					...
					<ol>
						<li>1. 本規約は、「ANA公式WEBサイト」より対象となる航空券を購入した利用者（以下「ユーザー」といいます。）に対して「NINJA
							Wifi」の利用に関するクーポンコードを発行するサービス（以下「本サービス」といいます。）を提供するにあたり、そのクーポンコードの発行及び使用に関する諸条件を定めるものです。
						</li>
						<li>2. AdAsia Holdings PTE LTD（以下「当社」といいます。）は、「ANA航空券×NINJA
							WiFiキャンペーン」の実施及びクーポンコードの発行について、全日本空輸株式会社（以下「ANA」といいます。）から委託を受けています。
						</li>
					...
					<ol>
						...
						<li>2.
							ユーザーは、「ANA公式WEBサイト」からの対象航空券の購入に際して、ANAが提示する各種規約、ガイドライン等を遵守しなければなりません。なお、航空券の購入、変更、キャンセル等については、当該規約等が適用となります。
						</li>
						<li>3. ユーザーは、クーポンコードを使用して「NINJA WiFi」サービスに契約申込して同サービスを利用する場合、「NINJA
							WiFi」サービスを運営する株式会社ビジョン（以下「ビジョン」といいます。）が提示する各種規約、ガイドライン等を遵守しなければなりません。なお、NINJA
							WiFiの利用申込、利用、変更、キャンセル等については、当該規約等が適用となります。
						</li>
						<li>4.
							本規約のほか、クーポンコードの発行若しくは利用に関してANA若しくはビジョンが提示する条件等が存在する場合、同条件等も、クーポンコードの発行若しくは使用に適用されるものとします。なお、本規約とANA若しくはビジョンが提示する条件等に相違がある場合は、ANA若しくはビジョンが提示する条件等が本規約に優先して適用されるものとします。
						</li>
					</ol>
					<p>第３条（クーポンの発行）</p>
					<ol>
						<li>1.
							当社は、対象航空券を購入したユーザーに対して、クーポンコードの申込用URLを提供します。クーポンの発行申込は、当該ユーザーが申込用URLのフォームを利用して航空券の予約番号及び住所氏名等の必要事項を入力し、送信ボタンを押下することにより完了するものとします。
						</li>
						<li>2. 当社は、ユーザーが前項のクーポンの発行申込を完了した時点をもって、当該ユーザーが本規約のすべての条項に同意したものとみなします。</li>
						<li>3.
							当社は、ユーザーのクーポン発行申込を承認してクーポンコードを発行する場合、ユーザーが申込時に指定した電子メールアドレスへのクーポンコードを記載した電子メールの送信及び当社が指定するWEBページでの掲載によって、同クーポンコードを発行するものとします。
						</li>
						<li>4.
							ユーザーは、申込に際して指定した電子メールアドレスについて迷惑メール対策の設定をしている場合、同設定を変更し、当社からの電子メールを受信できるようにしなければなりません。同設定の変更を怠ったことによってユーザーがクーポンコードを入手できなかった場合でも、当社は、一切責任を負わないものとします。
						</li>
					...
					<ol>
						...
						<li>2. ユーザーは、クーポンコードの発行後、当社が定める期間内にNINJA
							WiFiに関するWEBサイトを訪問して、同サービスの利用申込をしなければなりません。同期間を経過した場合、未使用のクーポンコードは、無効になるものとします。
						</li>
						<li>3. ユーザーは、NINJA WiFiの利用申込の際にクーポンコードを使用して同申込をするものとします。</li>
						<li>4. ユーザーがクーポンコードを使用せずにNINJA
							WiFiの利用申込をした場合若しくは前項の期間内にクーポンコードを使用しなかった場合でも、当社は、同不使用について一切責任を負わないものとします。
						</li>
						<li>5. ユーザーは、クーポンコードを厳重に管理しなければなりません。</li>
						<li>6.
							発行されたクーポンコードは、申込をしたユーザー本人のみ使用することができます。ユーザーは、クーポンコードを第三者に譲渡、貸与等をしてはなりません。また、ユーザーは、クーポンコードの申込及びNINJA
							WiFiの利用申込に際して、第三者の名義等を使用してはなりません。
						</li>
					...
					<ol>
						<li>1. NINJA
							WiFiサービスでのクーポンコードの使用の是非に関する最終決定権は、ビジョンに帰属します。ビジョンがクーポンコードの使用を拒絶した場合でも、当社は、ユーザーに対して、同クーポンコードの使用によって得られるべき利益等の賠償義務を一切負わないものとします。
						</li>
						<li>2.
							ユーザーは、クーポンコードの発行後において対象航空券の搭乗日時、搭乗便等を変更する場合、ANAの定める手段等によって同変更等をするものとします。なお、当社は、同変更等によってクーポンコードを使用できなくなった場合でも、一切の責任を負わないものとします。
						</li>
						<li>3. ユーザーは、前項の変更に伴い、NINJA
							WiFiのサービス利用契約の日時、ルーター等の受取場所等を変更する場合、ビジョンが定める手段によって同変更等をするものとします。なお、当社は、同変更等によってクーポンコードを使用できなくなった場合でも、一切の責任を負わないものとします。
						</li>
					</ol>
					...
					<ol>
						<li>1.
							当社からユーザーに対して本サービスに係る重要な通知を送信する場合、同通知は、第３条３項に定める電子メールアドレスへの電子メールの送信若しくはその他当社が適当であると判断する手段によって行われるものとします。
						</li>
						<li>2.
							ユーザーが第３条４項の電子メールの受信設定の変更を怠ったことに起因して当社からの重要な通知を受領できなかった場合でも、当社は、それによってユーザーに生じる損害等について、一切責任を負わないものとします。
						</li>
					...
					<ol>
						...
						<li>3.
							前項の事由により本サービスが終了した場合でも、すでに発行されたクーポンコードは、有効に存続するものとします。ただし、ビジョンがクーポンコードの使用を拒絶した場合は、この限りではありません。
						</li>
					</ol>
					<p>第１０条（合意管轄、準拠法）</p>
					<ol>
						...
						<li>3. 対象航空券に関する紛争、NINJA
							WiFiサービスの利用に係る紛争については、ANA若しくはビジョンが提示する規約等に基づいてユーザーとANA間若しくはユーザーとビジョン間で解決されるものとし、当社は、同紛争について、情報の提供等必要な協力以外の責任を一切負わないものとします。
						</li>
						<li>4.
							本規約その他の本サービスに係る各規約及びガイドラインの他国語への翻訳版は、ユーザーの便宜を図ることのみを目的として当社が提供するものであり、ユーザーは、日本語版の規約が当社とユーザーとのすべての関係に適用されることに予め同意するものとします。
						</li>
					</ol>
					<p>第１１条（本規約の変更）</p>
					<ol>
