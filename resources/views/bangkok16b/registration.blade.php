        ...
        <form method="POST" action="/bangkok16b/confirm" accept-charset="UTF-8" id="inputForm" name="inputForm">
            ...
            <div class="contents">
                <div class="contents-header">
                    <p class="contents-header-required">* is mandatory field.</p>
                </div>
                ...
                <div class="contents-wrapper">
                    ...
                    <div class="eticket-number">
                        <div class="eticket-number-input">
                            <dl>
                                <dt><label>Reservation Number</label> <span class="form--attention">*</span></dt>
                                <dd class="tf-checker">
                    ...
                    <div class="eticket-number">
                        <div class="eticket-number-input">
                            <dl>
                                <dt><label>ANA E-ticket number</label> <span class="form--attention">*</span></dt>
                                <dd class="tf-checker">
                    ...
                    <div class="eticket-number">
                        <div class="eticket-number-input">
                            <dl>
                                <dt><label>Boarding date of your flight from Bangkok to Tokyo</label> <span class="form--attention">*</span></dt>
                                <dd class="tf-checker">
            ...
            <div class="contents_form">
                <div class="form-input">
                    ...
                    <dl>
                        <dt><label>Age</label> <span class="form--attention">*</span></dt>
                        <dd class="tf-checker">
                    ...
                    <dl>
                        <dt><label>Holder of airline frequent flyer program</label> <span class="form--attention">*</span></dt>
                        <dd class="form-checkbox holder">
                            ...
                            <p class="holder"><input id="Thai" class="checkbox" name="holder_of_airline[]" type="checkbox" value="Thai" {{in_array('Thai',array_get($form,'holder_of_airline',[]))?'checked':''}}><label for="Thai" class="checkbox"><span>Thai Airways</span></label></p>
                            ...
                            <p class="holder"><input id="Others" class="checkbox" name="holder_of_airline[]" type="checkbox" value="Others" {{in_array('Others',array_get($form,'holder_of_airline',[]))?'checked':''}}><label for="Others" class="checkbox"><span>Others</span></label></p>
                            <p class="holder"><input id="No" class="checkbox" name="holder_of_airline[]" type="checkbox" value="No" {{in_array('No',array_get($form,'holder_of_airline',[]))?'checked':''}}><label for="No" class="checkbox"><span>No</span></label></p>
                        </dd>
                    ...
                    <dl>
                        <dt><label>Motive for your ticket purchase through ANA website Thailand</label> <span class="form--attention">*</span></dt>
                        <dd class="form-checkbox holder">
                            <p class="holder"><input id="deals" class="checkbox" name="motive_for_your_ticket[]" type="checkbox" value="deals" {{in_array('deals',array_get($form,'motive_for_your_ticket',[]))?'checked':''}}><label for="deals" class="checkbox"><span>Better deals than other airlines or booking channels</span></label></p>
                            <p class="holder"><input id="advantage" class="checkbox" name="motive_for_your_ticket[]" type="checkbox" value="advantage" {{in_array('advantage',array_get($form,'motive_for_your_ticket',[]))?'checked':''}}><label for="advantage" class="checkbox"><span>Taking advantage of this campaign</span></label></p>
                            <p class="holder"><input id="noseats" class="checkbox" name="motive_for_your_ticket[]" type="checkbox" value="noseats" {{in_array('noseats',array_get($form,'motive_for_your_ticket',[]))?'checked':''}}><label for="noseats" class="checkbox"><span>No available seats on your preferred airlines</span></label></p>
                            <p class="holder"><input id="ANAnetwork" class="checkbox" name="motive_for_your_ticket[]" type="checkbox" value="ANAnetwork" {{in_array('ANAnetwork',array_get($form,'motive_for_your_ticket',[]))?'checked':''}}><label for="ANAnetwork" class="checkbox"><span>ANA's extensive network</span></label></p>
                            <p class="holder"><input id="frequentANA" class="checkbox" name="motive_for_your_ticket[]" type="checkbox" value="frequentANA" {{in_array('frequentANA',array_get($form,'motive_for_your_ticket',[]))?'checked':''}}><label for="frequentANA" class="checkbox"><span>Frequent customer of ANA</span></label></p>
                            <p class="holder"><input id="ANAservice" class="checkbox" name="motive_for_your_ticket[]" type="checkbox" value="ANAservice" {{in_array('ANAservice',array_get($form,'motive_for_your_ticket',[]))?'checked':''}}><label for="ANAservice" class="checkbox"><span>Keen on ANA's service</span></label></p>
                            <p class="holder"><input id="GoodANA" class="checkbox" name="motive_for_your_ticket[]" type="checkbox" value="GoodANA" {{in_array('GoodANA',array_get($form,'motive_for_your_ticket',[]))?'checked':''}}><label for="GoodANA" class="checkbox"><span>Good reputation about ANA from your acquaintance or media</span></label></p>
                            <p class="holder"><input id="Other" class="checkbox" name="motive_for_your_ticket[]" type="checkbox" value="Other" {{in_array('Other',array_get($form,'motive_for_your_ticket',[]))?'checked':''}}><label for="Other" class="checkbox"><span>Other (if any, specify)</span></label></p>
                            <p class="holder"><input id="No_particular" class="checkbox" name="motive_for_your_ticket[]" type="checkbox" value="No_particular" {{in_array('No_particular',array_get($form,'motive_for_your_ticket',[]))?'checked':''}}><label for="No_particular" class="checkbox"><span>None in particular</span></label></p>
                        </dd>
                    ...
                    <div class="form-checkbox agree_newsletter">
                        <p class="agree_newsletter"><input id="agree_newsletter" class="checkbox" checked="checked" name="agree_newsletter" type="checkbox" value="1"><label for="agree_newsletter" class="checkbox"><span>Check this box if you would like to subscribe for e-newsletter from ANA.</span></label></p>
                    </div>
                </div>
                <!-- /form-input -->
                ...
                <div class="form-btn tf-checker">
                    <div class="form-checkbox">
                        <p class="policy"><input id="policy" name="privacy" type="checkbox" class="checkbox tf-required"><label for="policy" class="checkbox"><span>I agree with the ANA's <a href="http://www.ana.co.jp/wws/privacy/e/ana.html" target="_blank">privacy policy</a></span></label></p>
                    ...
                    <div class="submit-btn">
                        <button type="submit" name="confirm-btn" id="submit" class="submit disabled" value="CONFIRM">Confirm<i class="fa-angle-right"></i></button>
                    </div>
                </div>
