        ...
        <form method="POST" action="/bangkok16b/thankyou" accept-charset="UTF-8" id="inputForm" name="inputForm">
                ...
                <div class="contents-wrapper">
                    ...
                    <div class="eticket-number">
                        <div class="eticket-number-confirm">
                            <dl>
                                <dt><label>หมายเลขการสำรองที่นั่ง</label></dt>
                    ...
                    <div class="eticket-number">
                        <div class="eticket-number-confirm">
                            <dl>
                                <dt><label>วันออกเดินทางของเที่ยวบินจากกรุงเทพไปญี่ปุ่น</label></dt>
            ...
            <div class="contents_form-confirm">
                <div class="form-confirm">
                    <dl>
                        <dt><label>เพศ</label></dt>
                        <dd><p>{{$genderList[array_get($form,'gender')]}}</p></dd>
                    </dl>

                    <dl>
                        <dt><label>ชื่อจริง</label></dt>
                        <dd><p>{{array_get($form,'first_name')}}</p></dd>
                    </dl>

                    <dl>
                        <dt><label>นามสกุล</label></dt>
                        <dd><p>{{array_get($form,'last_name')}}</p></dd>
                    </dl>

                    <dl>
                        <dt><label>อายุ</label></dt>
                        <dd><p>{{array_get($form,'age')}}</p></dd>
                    </dl>

                    <dl>
                        <dt><label>เบอร์โทรศัพท์มือถือ</label></dt>
                        <dd><p>{{array_get($form,'mobile')}}</p></dd>
                    </dl>

                    <dl>
                        <dt><label>อีเมล์</label></dt>
                        <dd><p>{{array_get($form,'email')}}</p></dd>
                    </dl>

                    <dl>
                        <dt><label>ท่านมีโปรแกรมสะสมไมล์ของสายการบินหรือไม่</label></dt>
                    ...
                    <div class="form-checkbox">
                        <p class="agree_newsletter confirm">
                            ...
                            <span>หากท่านต้องการรับข่าวสารและข้อเสนอพิเศษทางอีเมล์จากANA  โปรดใส่เครื่องหมายในช่องนี้.</span>
                        </p>
                    </div>
                    ...
                    <div class="form-checkbox">
                        <p class="agree_newsletter confirm">
                            ...
                            <span>ข้าพเจ้ายอมรับในข้อตกลงและ<a href="https://www.ana.co.jp/wws/privacy/t/ana.html" target="_blank">เงื่อนไข และนโยบายความเป็นส่วนตัวของ ANA</a></span>
                        </p>
                    </div>
                </div>
            </div>
